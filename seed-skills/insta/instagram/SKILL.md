...
| `webimage.mjs <page url> --out <dir> [--all]` | A news page's own picture, saved, with the credit line |
| `render.mjs <slides.html> --size 1080x1350 --out <dir>` | Each `[data-slide]` to a PNG of exactly that size |
