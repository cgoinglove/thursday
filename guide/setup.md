...
ship with the app are every bot's alike: the browser; this Mac (listed on a Mac only); reading a
video, a podcast, an article or a PDF; answers built on published numbers, with charts; a daily news
