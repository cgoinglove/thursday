...
- **From your phone.** Connect Telegram, Discord or Slack in Settings › Phone and write to her there while the app runs on your computer. The app connects out to the chat service; nothing on your computer is opened to the internet. One person is let in per service, and you allow them on the computer's screen when the code it shows is the one their phone was sent. A page a bot made — a report, a deck, a design — arrives as pictures you can read in the chat; the page itself stays on your computer.
