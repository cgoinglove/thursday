 ...
 * (use-thursday), a call in writing puts it to her between turns (use-text-call). Pure:
 * it reads the inbox and words each item, and holds no state about what was told.
 */
