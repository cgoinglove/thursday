...
To look at it yourself, the `browser` skill says how a local file is opened. Do it only
when asked or when something looks wrong: testing upfront adds latency between the request
